...
Future<void> _makeIcon(int size) async {
  ...
  final paragraphBuilder = ui.ParagraphBuilder(
    ui.ParagraphStyle(textAlign: TextAlign.center, fontSize: size * 0.50, fontFamily: 'Arial'),
  )..pushStyle(ui.TextStyle(color: const Color(0xFFFFFFFF), fontWeight: ui.FontWeight.w700))
   ..addText('ب');
